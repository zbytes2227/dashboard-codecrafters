...
async function auth() {
  ...
  return (
    <section className="h-[100vh] dark:bg-white">
        ...
        <a href="/login" class="text-white bg-red-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg mt-4 text-sm  sm:w-auto px-5 py-2.5 text-center"
        >Login</a>
        <a href="/register"  
          class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg mt-4 text-sm  sm:w-auto px-5 py-2.5 text-center"
          >Register</a>
          </div>
